...
function update(dt)
{
	...
	if (interpolateTime !== null)
	{
		...
		//console.log("CURRENT TOP COLOR = " + currentTopColor);
		//console.log("NEW TOP COLOR = " + rgbToHex(currentTopColor));

		//root.style.setProperty('--project-window-top-color', rgbToHex(currentTopColor));
		//root.style.setProperty('--project-window-bottom-color', rgbToHex(currentBottomColor));
	}
